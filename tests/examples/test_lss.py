...
def test_global_selection():
    ...
    adapter.test([
        RxMsg(0x7e5, '04 01 00 00 00 00 00 00'),  # switch state global to configuration state

        RxMsg(0x7e5, '11 01 00 00 00 00 00 00'),  # set node id to 1
        TxMsg(0x7e4, '11 00 00 00 00 00 00 00'),  # receive the acknowledge

        RxMsg(0x601, '40 00 10 00 00 00 00 00'), # requesting via SDO on node 1 will still be unanswered

        RxMsg(0x7e5, '04 00 00 00 00 00 00 00'),  # switch state global back to waiting state
