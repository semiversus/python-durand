...
def test_config_sdo_server(node_id, sdo_server):
    ...
    adapter.test([
        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should be ignored (will be used later)

        RxMsg(0x600 + node_id, '40', sdo_server, '12 01 00 00 00 00'),  # read sdo server rx cob id
        TxMsg(0x580 + node_id, '43', sdo_server, '12 01 00 00 00 80'),  # should be 0x8000_0000
    ])
    ...
    adapter.test([
        ...
        RxMsg(0x600 + node_id, '23', sdo_server, '12 01 40 06 00 00'),  # set sdo server rx cob id to 0x640
        TxMsg(0x580 + node_id, '60', sdo_server, '12 01 00 00 00 00'),  # acknowledge

        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should still be ignored
    ])
    ...
    adapter.test([
        ...
        RxMsg(0x600 + node_id, '23', sdo_server, '12 02 C0 05 00 00'),  # set sdo server tx cob id to 0x5C0
        TxMsg(0x580 + node_id, '60', sdo_server, '12 02 00 00 00 00'),  # acknowledge

        # check sdo server
        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should now work (read number of subindex in object 0x1200)
        TxMsg(0x5C0, '4F 00 12 00 02 00 00 00'),  # response with number of subindex (3)
    ])
    ...
    adapter.test([
        ...
        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should now work (read number of subindex in object 0x1200)
        TxMsg(0x5D0, '4F 00 12 00 02 00 00 00'),  # response with number of subindex (3)
    ])
    ...
    adapter.test([
        ...
        RxMsg(0x600 + node_id, '23', sdo_server, '12 01 00 00 00 80'),  # set sdo server rx cob id to 0x8000_0000
        TxMsg(0x580 + node_id, '60', sdo_server, '12 01 00 00 00 00'),  # acknowledge

        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should now be ignored
    ])
    ...
    adapter.test([
        ...
        RxMsg(0x600 + node_id, '23', sdo_server, '12 01 41 06 00 00'),  # set sdo server rx cob id to 0x641
        TxMsg(0x580 + node_id, '60', sdo_server, '12 01 00 00 00 00'),  # acknowledge

        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should now be ignored

        RxMsg(0x641, '40 00 12 00 00 00 00 00'),  # cob_id 641h should now work (read number of subindex in object 0x1200)
        TxMsg(0x5D0, '4F 00 12 00 02 00 00 00'),  # response with number of subindex (3)
    ])
    ...
    adapter.test([
        RxMsg(0x640, '40 00 12 00 00 00 00 00'),  # cob_id 640h should now be ignored
        RxMsg(0x641, '40 00 12 00 00 00 00 00'),  # cob_id 641h should now be ignored

        RxMsg(0x642, '40 00 12 00 00 00 00 00'),  # cob_id 642h should work (read number of subindex in object 0x1200)
        TxMsg(0x5D0, '4F 00 12 00 02 00 00 00'),  # response with number of subindex (3)
    ])
    ...
    adapter.test([
        RxMsg(0x642, '40 00 12 00 00 00 00 00'),  # cob_id 642h should now be ignored
    ])
